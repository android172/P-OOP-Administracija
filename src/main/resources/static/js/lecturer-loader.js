...
function init(){
	makeRequest('/get_lecturer',[['lectId',index]],function(lecturerData){loadLecturerData(lecturerData);});
	makeRequest('/get_subjects_by_lecturer',[['lect_id',index]],function(lecturerSubData){loadLecturerSubjects(lecturerSubData);});
	makeRequest('get_exams_for_lecturer',[['lecturer_id',index]],function(examData){loadExamDeadline(examData);});
}